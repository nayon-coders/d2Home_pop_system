...
class OrderCalculate extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Row(
          ...
          children: [
            _informationWidget(context, notifier, rightNotifier, state, stateRight),
            16.horizontalSpace,
  ...
  Widget calculator(RightSideState stateRight,
      RightSideNotifier rightSideNotifier) {
    var totalPrice = stateRight.paginateResponse!.totalPrice! -
        stateRight.paginateResponse!.serviceFee!;
    return Expanded(
      child: Container(
          ...
          children: [
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                Get.find<PaymentCalculatorController>()
                                    .changeSelectionBox(true);
                              },
                              child: Container(
                                height: 50,
                                width: 170,
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            "${stateRight.selectedUser?.firstname ??
                                ""} ${stateRight.selectedUser?.lastname ?? ""}",
                            style: GoogleFonts.inter(
                                fontWeight: FontWeight.w600, fontSize: 18.sp),
                          ),
                          Text(
                            "#${AppHelpers.getTranslation(TrKeys
                                .id)}${stateRight.selectedUser?.id ?? ""}",
                            style: GoogleFonts.inter(
            ...
            GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      Get.find<PaymentCalculatorController>().setCalculate(
                          index == 9
                              ? "00"
                              : index == 10
                              ? "0"
                              ...
                              ? "-1"
                              : (index + 1).toString(),
                          double.tryParse("${totalPrice}")!);

                      Get.find<PaymentCalculatorController>().calculateBalance(
                          double.tryParse(
                              "${totalPrice}")!); // Call after setting cash/card amount
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "${stateRight.bags[stateRight.selectedBagIndex]
                                  .selectedUser?.firstname ?? ""} ${stateRight
                        ...
                        ListView.builder(
                          ...
                          physics: const NeverScrollableScrollPhysics(),
                          shrinkWrap: true,
                          itemCount: stateRight.paginateResponse?.stocks
                              ?.length ?? 0,
                          itemBuilder: (context, index) {
                            final stock = stateRight.paginateResponse
                                ?.stocks?[index];
                            return Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        stock?.stock?.product?.translation
                                            ?.title ?? "",
                                        style: GoogleFonts.inter(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 16.sp,
